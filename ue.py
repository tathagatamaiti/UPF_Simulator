...
class UE:
    ...
    pdu_session_id = "PDU ID"
    pdu_session = "PDU SESSION GENERATED BY THE UE"
    pdu_class = "CLASS OF PDU BEING GENERATED"
    pdu_duration = np.random.exponential(scale=5)  # DURATION OF THE PDU SESSION
    pdu_start_time = "START TIME OF THE PDU SESSION"
    ...
    def generate_pdu_session(self):
        pdu_session = f"{self.name}_pdu{self.pdu_session_id}"
    ...
    def pdu_session_generation(self, scheduler):
        ...
        pdu_start_time = scheduler.current_time
